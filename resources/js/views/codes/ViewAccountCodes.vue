...
<script>
    export default {
        ...
        methods: {
            fetchData(accountCode) {
                if (accountCode) {
                    this.accountCodes = accountCode
                } else {
            ...
            openEditDialog(accountCode) {
                this.editItem = JSON.parse(JSON.stringify(accountCode))
            ...
            openDeleteDialog(accountCode) {
                this.deleteItem = accountCode
